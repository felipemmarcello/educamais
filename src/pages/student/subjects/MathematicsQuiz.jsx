...
const MathematicsQuiz = () => {
  ...
  useEffect(() => {
    const checkAnsweredBefore = async () => {
      if (user) {
        ...
        const responseSnapshot = await getDocs(collection(db, "userMathematicsResponses"));
  ...
  const handleSubmit = async () => {
    ...
    const userResponseQuery = collection(db, "userMathematicsResponses");
    ...
    await addDoc(collection(db, "userMathematicsResponses"), {
      userId: user.uid,
