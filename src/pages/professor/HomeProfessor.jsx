...
function HomeProfessor() { // Asumindo que 'user' está sendo compartilhado através do contexto
    ...
    <div>
      ...
      <Box sx={{ display: 'flex', flexDirection: 'column', paddingLeft: '3%' ,paddingTop: '5%' }}>
        <Typography variant="body1">
          Este é o conteúdo principal da página do Professor. Aqui, você tem acesso completo às máterias, conteúdos, perguntas e respostas do Educa+.
        </Typography>
      </Box>
    </div>
  );
